    ...
    fields: [
      {
        ...
        title: "API Key",
        description:
          "you can get your API key in https://www.coinbase.com/settings/api",
        type: "password",
        placeholder: "API Key",
        icon: "key"
      },
      {
        ...
        description:
          "you can get your Secret API key in https://www.coinbase.com/settings/api",
        type: "password",
      ...
      },
      {
        name: "WebhookUrl",
        title:
          "Notifications url. Fill this notifications url on API key creation",
...
function getError(code) {
  ...
  var errors = [
    ...
    },
    {
      ...
      code: 400,
      description: "Identity verification is required to complete this request"
    },
    {
      id: "jumio_verification_required",
      code: 400,
      description: "Document verification is required to complete this request"
    },
    {
      id: "jumio_face_match_verification_required",
      code: 400,
      description:
